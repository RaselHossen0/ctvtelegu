...
class HomeScreenState extends State<HomeScreen>
  ...
  void getSections() {
    Future.delayed(Duration.zero, () {
      context.read<SectionCubit>().getSection(
          ...
          longitude: lon
              .toString()); //pass latitude and longitude to get location wise news
    });
  }
  ...
  Widget getSectionList() {
    return BlocBuilder<GeneralNewsCubit, GeneralNewsState>(
      ...
      return BlocBuilder<SectionCubit, SectionState>(
        ...
        //print(sectionState.toString());

        if (sectionState is SectionFetchSuccess) {
          print(sectionState.section.length);
          // print(sectionState.section.first.);
          ...
          //           onRetry: _refresh);
          //     }
          //   } else if (sectionState.section.first.newsTotal != null &&
          //       sectionState.section.first.newsTotal! == 0) {
          //     return ErrorContainerWidget(
          //         errorMsg: ErrorMessageKeys.noDataMessage, onRetry: _refresh);
          //   }
          // }
          return SizedBox(
            ...
            child: ListView.builder(
                ...
                itemBuilder: ((context, index) {
                  ...
                  // print(
                  //     "sectionState.section[index] ${sectionState.section[index]}");
                  FeatureSectionModel model = sectionState.section[index];
                  // print(model.title);
                  // print(model.newsType);
  ...
  getPages() {
    Future.delayed(Duration.zero, () {
      context
          .read<OtherPageCubit>()
          .getOtherPage(langId: context.read<AppLocalizationCubit>().state.id);
    });
  }
