...
class NewsSubDetailsState extends State<NewsSubDetails> {
  ...
  shareButton() async {
    print('this sahre');
    String base64Image = '';
    var im = await screenshotController.capture();
    if (im == null) {
      return;
    }
    ...
    final file =
        await File('${tempDir.path}/${DateTime.now().toString()}.png').create();
    await file.writeAsBytes(im!);
  ...
  otherMainDetails() {
    int readingTime = UiUtils.calculateReadingTime(
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (!isReply && !comEnabled)
                      Padding(
                          ...
                          child: Row(mainAxisSize: MainAxisSize.min, children: [
                            if (!widget.isFromBreak)
                              dateView(context, newsModel!.date!),
                    ...
                    if (!isReply && !comEnabled)
                      descView(
                          desc: widget.isFromBreak
                              ? widget.breakModel!.desc!
                              : newsModel!.desc!,
                          context: context,
                          fontValue: fontValue.toDouble()),
                  ],
                ),
            ...
            child: SingleChildScrollView(
                ...
                child: Stack(children: <Widget>[
                  ...
                  videoBtn(
                      ...
                      model: !widget.isFromBreak ? newsModel! : null,
                      breakModel:
                          widget.isFromBreak ? widget.breakModel! : null),
                  otherMainDetails(),
