...
const String baseUrl = "https://admin.ctvtelugu.com";
...
const String deepLinkUrlPrefix =
    'https://ctvtelugu.page.link'; //example - https://xxx.page.link - Your dynamic link from Firebase
const String deeplinkURL =
    'ctvtelugu.com'; //example - xxx.com - Your domain name
